...
// ---------------------------------------------------------------------------
// Curve genrator based on Embree's curve_geometry tutorial
//
...
/* add hair geometry */
unsigned int addCurve (RTCDevice device, RTCScene scene, const Vec3fa& pos)
{
...
int main(int argc, char **argv) {
  ...
  addCurve(device, scene, Vec3fa(0.0f, 0.0f, 0.0f));
