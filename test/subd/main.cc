...
// ---------------------------------------------------------------------------
// SubD genrator based on Embree's subduvision_geometry tutorial
//
...
unsigned int addCube (RTCDevice device, RTCScene scene_i)
{
  ...
  rtcSetSharedGeometryBuffer(geom, RTC_BUFFER_TYPE_VERTEX, 0, RTC_FORMAT_FLOAT3, cube_vertices, 0, sizeof(float) * 4, 8);
  ...
  rtcSetSharedGeometryBuffer(geom, RTC_BUFFER_TYPE_VERTEX_ATTRIBUTE, 0, RTC_FORMAT_FLOAT3, cube_colors, 0, sizeof(float) * 4, 8);
